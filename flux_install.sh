...
https://freeswitch.org/confluence/display/FREESWITCH/HOWTO+Create+a+SignalWire+Personal+Access+Token"
        ...
        if [ $DIST = "DEBIAN10" ]; then
                ...
                if [ $verify_debian10 = 0 ]; then
                        ...
                        echo "******************************************************************************"
                        echo ""
                        echo "For more information daniel@flux.net.br "
                        echo ""
                        echo "******************************************************************************"
                        sleep 3s
                        tput sgr0
...
{
        cd /opt
        git clone -b V6.0 https://github.com/fluxtelecom/fluxsbc/ flux
...
install_database ()
{
        ...
        mysql -uroot -p${MYSQL_ROOT_PASSWORD} flux < ${FLUX_SOURCE_DIR}/database/flux-6.0.2.sql
}
