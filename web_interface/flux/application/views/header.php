...
<head>
 ...
 <title>
	...
	<?php
		...
		<? start_block_marker('page-title') ?><? end_block_marker() ?> | Flux SBC - Unindo pessoas e negócios
	<?php
	}
	?>
</title>
...
<!--     <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/custome_index.css" type="text/css"/>-->
  <!-- Google Font -->
