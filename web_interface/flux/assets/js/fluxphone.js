/*
   ...
   The Original Code is FluxPhone
...
//        wsServers: which_server,
        ...
        password: password,
        contactName: login,
        userAgentString: 'SIP.js/0.7.8 FluxPhone 01',
        ...
        traceSip: true,
        turnServers: [{urls: 'turn:dev.flux.net.br:5349', username: 'flux', credential: 'Flux223304442Dev2516'}],
